...
student1:Student = Student("Sara Malik",95)
...
emp1 : Employee = Employee("Sara Malik",5000,"132-45-6754")   
print(emp1.name)
print(emp1._salary)
#print(emp1.__ssn)     
...
teacher: Teacher = Teacher("Sara Malik","English")  
...
employee1:Employee = Employee("Sara",department)
